...
router.post('/product/all', async function(req, res, next) {
    // var product = await Product.find({ shop: req.body.shopId, subcategory: req.body.subCatId }).populate("shop subcategory category variable");
    res.json({
        message: 'success',
        data: req
    });
