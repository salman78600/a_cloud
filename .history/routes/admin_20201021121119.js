...
router.get('/variables/all', async function(req, res, next) {
    var cat = await Variable.find().populate("category subcategory")
    res.json({
        message: 'success',
        data: cat
    });
...
router.post('/variables/create', async function(req, res, next) {
    Variable.create({
        name: req.body.name,
...
router.post('/variables/update', async function(req, res, next) {
...
router.post('/variables/delete', async function(req, res, next) {
