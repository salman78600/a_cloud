...
/* Dashboard  Package ========= Start */
router.get('/package/all', async function(req, res, next) {
...
router.post('/package/create', function(req, res, next) {
    Package.create({
        name: req.body.name,
...
router.post('/package/update', async function(req, res, next) {
    Package.updateOne({ _id: req.body.id }, {
        $set: {
            name: req.body.name,
            description: req.body.desc,
            price: req.body.price,
...
router.post('/package/delete', async function(req, res, next) {
    await Package.deleteOne({ _id: req.body.id })
    res.json({
        message: 'Successfully deleted',
    });
});
/* Dashboard  Package ========= End */
...
router.get('/setting/all', async function(req, res, next) {
    var fetch = await Setting.find();
    res.json({
        message: 'success',
        data: fetch[0]
...
router.post('/setting/update', async function(req, res, next) {
    Setting.updateOne({ _id: req.body.id }, {
        $set: {
            ...
            freeCreditOnShopCreate: req.body.freeCreditOnShopCreate,
            creditDeductionOnAddProduct: req.body.creditDeductionOnAddProduct,
            creditDeductionOnSendingCustomNotification: req.body.creditDeductionOnSendingCustomNotification,
            creditDeductionOnPromoteProduct: req.body.creditDeductionOnPromoteProduct,
            promoteProductTime: req.body.promoteProductTime,
            creditDeductionOnPromoteShop: req.body.creditDeductionOnPromoteShop,
            promoteShopTime: req.body.promoteShopTime,
            creditAdditionOnVideoAd: req.body.creditAdditionOnVideoAd,
            creditAdditionOnQrScan: req.body.creditAdditionOnQrScan,
...
/* Dashboard  Promo ========= Start */
router.get('/promo/all', async function(req, res, next) {
    var fetch = await Promo.find();
    res.json({
        message: 'success',
        data: fetch
    });
...
router.post('/promo/create', function(req, res, next) {
    Promo.create({
        image: req.body.image,
        days: req.body.days,
        link: req.body.link,
...
router.post('/promo/update', async function(req, res, next) {
    Promo.updateOne({ _id: req.body.id }, {
        $set: {
            image: req.body.image,
            days: req.body.days,
            status: req.body.status,
...
router.post('/promo/delete', async function(req, res, next) {
...
router.get('/contactUs/all', async function(req, res, next) {
    var fetch = await ContactUs.find().populate("user");
    res.json({
        message: 'success',
        data: fetch
    });
});
router.post('/contactUs/read', async function(req, res, next) {
    ContactUs.updateOne({ _id: req.body.id }, {
        $set: {
            status: req.body.status,
        }
    }).then(r => {
...
/* Dashboard  Contact Us ========= End */



/* Dashboard  Report ========= Start */
router.get('/report/all', async function(req, res, next) {
    var fetch = await Report.find().populate("user shop");
    res.json({
        message: 'success',
        data: fetch
    });
...
router.post('/report/read', async function(req, res, next) {
...
router.post('/report/delete', async function(req, res, next) {
    await Report.deleteOne({ _id: req.body.id })
    res.json({
        message: 'Successfully deleted',
    });
});
...
router.get('/review/all', async function(req, res, next) {
    var fetch = await Review.find().populate("user shop");
    res.json({
        message: 'success',
        data: fetch
    });
});
router.post('/review/shop', async function(req, res, next) {
    var fetch = await Review.find({ shop: req.body.shopId }).populate("user shop");
    res.json({
        message: 'success',
        data: fetch
    });
